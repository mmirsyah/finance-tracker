...
BEGIN
    ...
    v_last_period_start := public.get_custom_period_start(v_current_period_start - INTERVAL '1 day', v_period_start_day);
    ...
    -- Kita menggunakan tanggal awal periode sebelumnya dan mengambil awal bulan kalender
