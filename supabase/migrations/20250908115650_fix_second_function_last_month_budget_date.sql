-- Memperbaiki perhitungan tanggal untuk mengambil anggaran bulan lalu pada fungsi kedua
...
-- Membuat fungsi baru dengan perhitungan tanggal yang benar
...
BEGIN
    -- Perbaikan: Menghitung tanggal periode dengan benar
    ...
    -- Perbaikan: Menghitung tanggal anggaran bulan lalu dengan benar
    -- Kita menggunakan tanggal awal periode dikurangi 1 bulan
    v_last_month_budget_date := date_trunc('month', public.get_custom_period_start(p_reference_date, v_start_day) - INTERVAL '1 month');
