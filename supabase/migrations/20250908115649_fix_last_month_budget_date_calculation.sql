-- Memperbaiki perhitungan tanggal untuk mengambil anggaran bulan lalu
-- Masalah sebelumnya: v_last_month_budget_date dihitung dari v_last_period_start yang merupakan tanggal terakhir bulan sebelumnya
-- Solusi: Menghitung v_last_month_budget_date langsung dari p_current_period_start
...
-- Membuat fungsi baru dengan tipe return yang diperbarui dan perhitungan tanggal yang benar
...
BEGIN
    ...
    -- Kita menggunakan tanggal awal bulan dari p_current_period_start dikurangi 1 bulan
    v_last_month_budget_date := date_trunc('month', p_current_period_start - INTERVAL '1 month');
