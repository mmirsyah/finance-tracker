-- Memperbaiki perhitungan tanggal untuk mengambil anggaran periode sebelumnya dengan mempertimbangkan periode kustom
...
BEGIN
    ...
    -- Asumsinya p_current_period_start sudah merupakan tanggal awal periode yang benar
    v_current_period_start := p_current_period_start;
    
    -- Menghitung periode sebelumnya dengan mengurangi 1 hari dari tanggal awal periode saat ini
    -- Ini akan memberikan tanggal di akhir periode sebelumnya
    v_last_period_end := v_current_period_start - INTERVAL '1 day';
    
    -- Menghitung tanggal awal periode sebelumnya dengan mengurangi 1 bulan penuh
    v_last_period_start := v_current_period_start - INTERVAL '1 month';
    ...
    -- Kita menggunakan tanggal awal periode saat ini dikurangi 1 bulan
    v_last_month_budget_date := date_trunc('month', v_current_period_start - INTERVAL '1 month');

    -- Untuk debugging - bisa dihapus setelah masalah terpecahkan
    RAISE LOG 'get_category_spending_history: v_current_period_start = %', v_current_period_start;
