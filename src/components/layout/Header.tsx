...
export default function Header({ onMenuClick, sidebarOpen }: HeaderProps) {
  ...
  const triggerSingleTransactionModal = () => {
    setTimeout(() => {
    ...
    return (
      <header className="sticky top-0 bg-card backdrop-blur-sm border-b border-background z-30 shadow-md">
        <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          {/* Mobile: Search icon in top right corner */}
  ...
  return (
    <header className="sticky top-0 bg-card backdrop-blur-sm border-b border-background z-30 shadow-md">
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Only show menu button on desktop when sidebar is closed */}
        {!sidebarOpen && (
        ...
        {/* Desktop: Show search bar in center */}
        <SearchBar />
        
        {/* Desktop: Show add transaction button */}
        <div className="flex items-center gap-2">
          <div className="flex items-center">
            {/* Main Action Button */}
            <Button 
