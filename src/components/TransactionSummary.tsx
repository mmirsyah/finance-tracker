...
// === PERBAIKAN DI SINI ===
// Sekarang bisa menerima string, null, atau undefined
const formatDate = (dateString: string | null | undefined) => {
  // Pengecekan `!dateString` sudah menangani null dan undefined
  ...
  useEffect(() => {
    if (userId) {
      ...
      const channel = supabase
       .channel(`transaction_summary_update_for_${userId}`) // Channel yang lebih unik
